##OK now this is the final step before you can go off and do whatever you want to the game
##first we will wrap the player's draw(), shoot(), movement method calls, and the enrinched
##for loops checking for bullet hits within an if statement
##checking if their health is greater than 0. So that dead players will disapear. 
...
while userIsPlaying:
    ...
    #Moved under player2 method calls#
    #for bullet in player1.bullets:
    #    if player2.isInHitBox(bullet.x,bullet.y):
    #        player2.health -= 5
    #        bullet.done = True
    ...
    #Moved under player1 method calls#
    #for bullet in player2.bullets:
    #    if player1.isInHitBox(bullet.x,bullet.y):
    #        player1.health -= 5
    #        bullet.done = True
