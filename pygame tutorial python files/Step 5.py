##Now we will create an instance of our class (also known as an object)
...
##variable called **player1** before the while loop giving the player the
##following initial attributes (x: 300, y: 410, width: 64, height: 64,
